...
function CreateBoxAsync(scene, callback) {
    ...
    for (var index = 0; index < spheresCount; index++) {
        var sphere = BABYLON.MeshBuilder.CreateSphere("Sphere" + index, { segments: 32, diameter: 3 }, scene);
    ...
    var plane = BABYLON.MeshBuilder.CreatePlane("map", { size: 10 }, scene);
...
function StartRenderer(callback)
{
    ...
    CreateBoxAsync(scene, callback).then(function () {
