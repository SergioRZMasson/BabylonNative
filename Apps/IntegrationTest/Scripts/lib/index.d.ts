...
import { createSceneAsync, destroyScene, setEnvironment } from "./sceneInterop";
import { createRenderTargetTexture, destroyRenderTargetTexture, getEngineInfo } from "./rendererInterop";
declare global {
