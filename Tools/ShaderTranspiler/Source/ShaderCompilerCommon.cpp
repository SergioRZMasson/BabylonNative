...
namespace Babylon::ShaderCompilerCommon
{
    ...
    ShaderTranspiler::BgfxShaderInfo CreateBgfxShader(ShaderInfo vertexShaderInfo, ShaderInfo fragmentShaderInfo)
    {
        ShaderTranspiler::BgfxShaderInfo bgfxShaderInfo{};
