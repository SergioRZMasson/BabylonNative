...
namespace Babylon::Graphics
{
    ...
    protected:
        ...
        void screenShot(const char* filePath, uint32_t width, uint32_t height, uint32_t pitch, bgfx::TextureFormat::Enum _format, const void* data, uint32_t size, bool yflip) override;
